# Galt Development Guide

## Python Version Compatibility

Galt must maintain compatibility with Python 3.7+ to support all VFX applications.
...
from galt.execution.engine import ExecutionEngine
from galt.ui.main_window import GaltWindow
```
...
from galt.config import SETTINGS  # absolute
...
cmds.workspaceControl(
    ...
    retain=False,
    floating=True,
    uiScript=f"galt.Go(embedded=True, workspace_control_name='{workspace_name}')"
)
```
