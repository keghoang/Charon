"""
Example of how to integrate WindowManager with the existing Galt code.
...
from ..galt_logger import system_info, system_debug
...
def launch_with_window_manager(global_path=None, host=None, dock=False, **kwargs):
    ...
    system_info(f"Launching Galt for host: {host}")
