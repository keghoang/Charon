...
class KeybindSettingsDialog(QtWidgets.QDialog):
    ...
    def _create_ui(self):
        ...
        # Create tabs - Global first, then Galt
        self._create_global_tab()
        self._create_local_tab()
        if self._host_allows_settings:
            self._create_settings_tab()
        # Conflicts tab removed - Galt handles conflicts automatically
    ...
    def _create_settings_tab(self):
        ...
        info = QtWidgets.QLabel(f"These Galt settings are only active when Galt is running inside of {host_label}.")
    ...
    def _reset_host_settings(self):
        ...
        reply = QtWidgets.QMessageBox.question(
            self,
            "Reset Settings",
            f"Reset Galt settings for {host_label}?",
    ...
    def _create_local_tab(self):
        ...
        info_label = QtWidgets.QLabel(
            "These keybinds are only active when Galt window has focus.\n"
            "They control Galt's UI functions."
        )
        ...
        self.tab_widget.addTab(widget, "Galt Keybinds")
    ...
    def _create_global_tab(self):
        ...
        # Info label
        info_label = QtWidgets.QLabel(
            "These keybinds are always active, even when Galt is not focused.\n"
    ...
    def _load_keybinds(self):
        ...
        self._load_app_settings()
        # Conflicts loading removed - Galt handles conflicts automatically
        ...
        if dialog.exec_() == QtWidgets.QDialog.Accepted:
            ...
            if conflicting_script:
                ...
                if conflicting_action:
                    # For Galt vs Galt, just reassign without asking
    ...
    def _edit_global_keybind(self, row: int):
        ...
        if dialog.exec_() == QtWidgets.QDialog.Accepted:
            ...
            if new_key in local_by_key:
                ...
                # Allow overwriting Galt keybind
                action_names = {
                    'quick_search': 'Quick Search',
                    'run_script': 'Run Script',
                    'refresh': 'Refresh',
    ...
    def _reset_local_keybinds(self):
        ...
        message = "Reset all Galt keybinds to their default values?"
    ...
    # Conflict resolution removed - Galt handles conflicts automatically
    '''
