...
Manages Galt's built-in UI keybinds that are only active when the window has focus.
"""
...
class LocalKeybindHandler(QtCore.QObject):
    """
    Handles local keybinds that are only active when Galt window has focus.
