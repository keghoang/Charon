...
This module handles conflicts between local (Galt) and global (script) keybinds.
...
class ConflictResolver:
    ...
    def show_conflict_warning(self, parent: QtWidgets.QWidget, 
        ...
        if hasattr(parent, 'window') and callable(parent.window):
            ...
            if isinstance(main_window, GaltWindow) and hasattr(main_window, 'keybind_manager'):
