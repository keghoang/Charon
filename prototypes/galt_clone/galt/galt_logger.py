...
- System messages: Galt's own operational messages (go to terminal only)
...
def _get_system_logger() -> logging.Logger:
    ...
    if _system_logger is None:
        # Create logger
        _system_logger = logging.getLogger('galt.system')
        ...
        formatter = logging.Formatter('[GALT] %(levelname)s: %(message)s')
